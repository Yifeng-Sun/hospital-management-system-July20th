<template>
  <div>
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>患者处置</el-breadcrumb-item>
    </el-breadcrumb>
    <br />
    <br />
    <!-- 两边的整体布局 -->
    <div class="Div">
      ...
      <div style="width:360px">
        ...
        <br />
        <el-link :underline="false" type="warning">未处置患者:</el-link>
        ...
        <el-table :data="tableData" size="mini" style="width: 100%" max-height="250">
          ...
          <el-table-column label="操作">
            <template slot-scope="scope">
              <el-button size="small" style="background-image:linear-gradient(134deg, #00e2ff 0%, #bb00ff 100%); color: white" @click="dia(scope.row)">处置</el-button>
            </template>
          </el-table-column>
        </el-table>
        <br />
        <br />
        <el-link :underline="false" type="success">已处置患者:</el-link>
      ...
      <div>
        ...
        <el-tabs v-model="activeName" style="width: 1150px">
          ...
          <el-tab-pane :disabled="paneDisable" label="处置项目">
            <el-card class="box-card" style="width: 98%">
              ...
              <div>
                <el-table :data="checkTable" style="width: 100%">
                  ...
                  <el-table-column prop="department" label="处置科室"></el-table-column>
