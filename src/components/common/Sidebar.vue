<template>
  <div class="sidebar-container" :class="{'collapse-width': sharedState.state.isCollapse}">
    <div class="logo" :class="{'collapse-logo': sharedState.state.isCollapse}">
      <el-image :src="imgSrc" style="width: 60px; height: 60px"></el-image>
    </div>
    <el-menu
      default-active="/"
      text-color="#000000"
      active-text-color="#600000"
...
export default {
  data() {
    return {
      imgSrc: require("../../../static/icons8-connect-64.png"),
...
.el-menu-vertical-demo:not(.el-menu--collapse) {
  width: 200px;
  height: 100%;
  background-image: linear-gradient(134deg, #00e2ff 0%,  #00e2fe 25%, #bb00ff 100%);
}
.el-menu-vertical-demo {
  height: 100%;
  background-image: linear-gradient(134deg, #00e2ff 0%,  #00e2fe 50%, #bb00ff 100%);
}
.el-menu {
  border: none;
  height: 100%;
...
.el-submenu .el-menu-item{
  background-color: rgba(187, 0, 255, 0);
    }
</style>